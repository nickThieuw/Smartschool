            ...
            <!-- Collect the nav links, forms, and other content for toggling -->
                    <div  class="collapse navbar-collapse head" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav" id="navbar-nav" style="box-shadow: rgba(6, 57, 106, 0) 0px 1px 5px 0px;">
                            <li style="margin-top: 20px; " class="active" ><a href="aanwezigheden.php">Afwezigheden</a></li>
...
<h2>Afwezigheden aanduiden</h2>
<p class="extraInfo">Klik op de afbeeldingen om de leerlingen die <span style="color:#D62522; font-weight: bold">afwezig</span> zijn aan te duiden</p>
<!-- De form die de aanwezigheden opvangt en doorgeeft aan de database-->
<form method="post" class="formDes" action="aanwezigheden.php?action=afw" id="inlogform">
                            
                        <input class="btn btn-success btn-sm" type="submit" value="afwezigheden doorgeven"/>
<!--omvatende div die de klaslijst heeft als inhoud-->
        <div class="row">
            ...
            <div class="col-sm-4 col-md-3">
             ...
             <div class="thumbnail" tabindex="<?php  echo $j ?>">
            <input class="checkbox" type="checkbox" name="afwezig<?php  echo $j ?>" id="afwezig<?php print($j);?>" <?php if($afwezighedenlijstvalues[$j]){?>checked<?php };?> >
            <label class="lblChk" for="afwezig<?php print($j);?>" aria-label="ok"></label>
            <img class="MobileMenuImg MobileMenuImgAfw" style="height: 200px; width: 100%; display: block;" src="<?php $foto_path=$leerling->getFoto(); $beschikbaar=file_exists($foto_path); if($beschikbaar){ echo $foto_path; }else{ echo "Foto_leerling/defaul_foto.png"; }?>?>" alt="default" style="width:100px;height:100px">    
            <div class="caption">
