...
<script src="http://code.angularjs.org/1.3.9/i18n/angular-locale_nl-be.js"></script>
  ...
  $(function() {
    $( "#dialog" ).dialog();
        ...
        <title>Smartschool > Toevoegen van nieuwe vakken</title>
        <script>
    $('#nav').affix({
});
    </script>
...
<!--imageslider bovenaan website-->
          ...
          <nav data-spy="affix" data-offset-top="50" id="nav"  class="navbar navbar-default navbar-fixed-top" role="navigation">
            ...
            <section class="OnderWeb">
                ...
                <form class="form-horizontal Verwerken" ng-controller="validationApp" method="post" name="userForm" action="vakkentoevoegen.php?action=process"  enctype="multipart/form-data"  ng-submit="submitForm(userForm.$valid)" novalidate>
                    ...
                    <input class="btn btn-success btn-sm" type="submit" value="Vak toevoegen"  ng-disabled="userForm.$invalid"/>
            ...
            <div class="input-group col-md-3">
                <input id="vakNaam" type="text" name="vakNaam"  class="form-control" ng-model="user.vakNaam" required>
            </div>
            </div>     
     </form>
            </section>
