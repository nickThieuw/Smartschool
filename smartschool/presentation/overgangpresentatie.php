...
<section class="OnderWeb" style="color: white">
<h2>Overgang voor volgend schooljaar</h2>
            <!--start items om info te tonen omtrent overgang-->
                ...
                <table class="table table-hover">
                    <th> &nbsp; klasnaam &nbsp; </th>
                    <th> &nbsp; Nieuw klas &nbsp; </th>
                    <th> &nbsp; Doorgestuurd door leerkracht ? &nbsp; </th>
                    <th> &nbsp; geslaagden &nbsp; </th>
    ...
    //                    echo '';
    //                    print_r($klasnamenArr);
    //                    echo '<br/>';
    //                    print_r($foundklasoverArr);
    //                    echo '<br/>';
    //                    print_r($geslaagdenArr);
    //                    echo '<br/>';
    //                    print_r($totleerlingenklasArr);
                    ?>

                </table>
                </div>
                <!--Einde table overzicht-->
                <a href="overgang.php?validation=Y" class="btn btn-success btn-sm btnVormgeving">Jaarovergang Volbrengen</a>
