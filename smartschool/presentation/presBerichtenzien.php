...
<body>
    <section class="wikkel">
        ...
        <section class="OnderWeb">
            <h2>Postvak IN</h2>
                    <div class="legend">
            <p>        
                Nieuw bericht = <span class="glyphicon glyphicon-star"></span></p>
        </div>
    ...
    <a class="LinkDes " href="bekijkbericht.php?onderwerp=<?php print($value['titel']);?>&&conversatie=<?php print($value['conversatie']);?>&&id=<?php print($value['id']);?>">
       
        <div class="row"> 
            <span class="<?php print($class);?> col-md-1"></span>
